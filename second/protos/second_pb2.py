...
_VOXELNET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='estimate_box_logvariance', full_name='second.protos.VoxelNet.estimate_box_logvariance', index=23,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='encode_direction_as_cartesian', full_name='second.protos.VoxelNet.encode_direction_as_cartesian', index=24,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='lidar_input', full_name='second.protos.VoxelNet.lidar_input', index=25,
